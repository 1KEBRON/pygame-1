...
#images
bg  = pygame.image.load("cosmos.jpg").convert()
intro_bg  = pygame.image.load("intro_bg.jpg").convert()
lvl30  = pygame.image.load("lvl30_bg.png").convert()
lvl55  = pygame.image.load("lvl55.jpg").convert()
lvl70  = pygame.image.load("lvl70.png").convert()
the_player = pygame.image.load( 'rocket.png' )
o_fireball  = pygame.image.load("fireball.png")
b_fireball  = pygame.image.load("enmy_lvl70.png")
